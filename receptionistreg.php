...
<head>
 ...
 <form action="subreceptionist.php" method="post" id="loginform">
       <div class="row">
       ...
       <div class="jumbotron">
        ...
        <div class="col-sm-4 fbox">
            ...
            <div class="col-sm-4 fbox">
                <div><h4>Receptionist Registration</h4></div></div>
                <div class="col-sm-4 fbox">
          ...
          <tr><td> <label class="control-label"> Name</label>
           ...
           <td><label class="control-label"> Reception ID</label>
           </td><td><input class="form-control" type="number" name="rid" required></td>
</tr>           
           <tr><td><label class="control-label">Age</label>
              ...
              <tr><td><label class="control-label">Address </label>
               </td><td><textarea class="form-control"rows="3" cols="40" name="address" ></textarea></td>
              <td> <label class="control-label">Blood Group</label>
               <select class="form-control" role="menu" name="bgroup">
          ...
          <tr><td> <label class="control-label"> Password</label>
           ...
           </td><td><input class="form-control" type="tel" name="phone" required></td>
</tr>      
          </table>
         ...
         <table class="table">
         <tr><td class="col-sm-5"></td><td><input type="submit" class="btn btn-success" value="Register" >
